...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Material Rates CUD
            <small>here delete material from database.</small>
        </h1>
        <ol class="breadcrumb">
            <li>
                <a href="dashboard.php"><i class="fa fa-dashboard"></i> Dashboard </a>
            </li>
            <li class="active"><i class="fa fa-trash"></i> Delete Material</li>
        </ol>
    </section>
            ...
            <form role="form" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                <div class="box-body">
                    ...
                    <div class="form-group" style="width : 50%">
                        ...
                        <input type="Text" class="form-control" name="id" placeholder="Enter Id Of Material">
                    </div>
